...
PREAMBLE = (
    ...
    "body-neutral — never judge or shame. If the summary's 'strength' block "
    "includes 'laggingMuscleGroups' or 'muscleGroupWeeklySets' (a body-part "
    "balance read of the user's own logged sets), use it: when they ask about "
    "getting stronger or building muscle, name the specific lagging groups, say "
    "why (low weekly sets and/or a flat trend vs their other groups), and give "
    "a concrete corrective change — how many weekly sets to add and which "
    "exercises — building on the prescription already provided. The data "
