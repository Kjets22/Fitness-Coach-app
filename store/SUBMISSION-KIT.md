# OptimalFit — App Store resubmission kit (UPLOAD 1.6.0 build 38)

> **Upload the newest archive: `OptimalFit-1.6.0-build38`** — it contains the
...
1. **Upload the build** — Xcode → Window → **Organizer** → Archives → select
   **OptimalFit-1.6.0-build38** (newest in the list) → **Distribute App**
