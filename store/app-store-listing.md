...
Tap your readiness ring to see exactly why it's at that number and how to
raise it. A "Do this next" card tells you the one thing to do right now and
changes through the day. Every exercise remembers its own rest time, and you
get credit when a session is done instead of tomorrow's workout in your face.

Under the hood: your logs are safer. Every tracker list now refreshes the
moment you open it, and anything that could ever replace your data keeps a
