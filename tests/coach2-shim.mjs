...
export function makeWorld(data = {}) {
  ...
  for (const f of ["evidence", "coach-profile", "coach-learn", "trainer", "coach-intake", "targets-engine", "insights-engine", "next-move", "night-out"]) {
  ...
  require(join(ROOT, "app/js/night-out.js"));
  world.OF = g.OF;
  world.store = store;
  return world;
}
